...
pub struct Config {
    ...
    /// The xADO staking contract address.
    pub staking_contract: Option<Addr>,
    /// Default bridge asset (Terra1 - LUNC, Terra2 - LUNA, etc.)
    pub default_bridge: Option<AssetInfo>,
    /// The vxADO fee distributor contract address
    pub governance_contract: Option<Addr>,
    /// The percentage of fees that go to the vxADO fee distributor
...
pub struct InstantiateMsg {
    ...
    /// The xADO staking contract address. If None then governance_contract must be set with 100% fee.
    pub staking_contract: Option<String>,
    /// The governance contract address (fee distributor for vxADO)
...
pub struct ConfigResponse {
    ...
    /// The xADO staking contract address
    pub staking_contract: Option<Addr>,
    /// The governance contract address (fee distributor for vxADO stakers)
    pub governance_contract: Option<Addr>,
    /// The percentage of fees that go to governance_contract
    pub governance_percent: Uint64,
    /// The maximum spread used when swapping fee tokens to ASTRO
    pub max_spread: Decimal,
    /// The remainder ASTRO tokens (accrued before the Maker is upgraded) to be distributed to xADO stakers
    pub remainder_reward: Uint128,
